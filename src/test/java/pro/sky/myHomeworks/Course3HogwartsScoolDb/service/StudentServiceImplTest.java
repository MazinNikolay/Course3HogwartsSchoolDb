...
/*
    ...
    void initial() {
        ...
        Student student = new Student("Tolik", 14);
        out.createStudent(student);
    }

    @Test
    void createStudent() {
        Student expected = new Student("Oleg", 14);
    ...
    @Test
    void getStudent() {
        Student expected = new Student("Tolik", 14);
    ...
    @Test
    void sortByAge() {
        Student student1 = new Student("Tolik", 14);
        Student student2 = new Student("Oleg", 14);
        Student student3 = new Student("Stepan", 15);
