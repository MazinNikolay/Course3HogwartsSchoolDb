...
/*    private FacultyServiceImpl out;
    ...
    void initial() {
        ...
        Faculty faculty = new Faculty("Griffindor", "yellow");
        out.createFaculty(faculty);
    }

    @Test
    void createfaculty() {
        Faculty expected = new Faculty("Griffindor", "yellow");
    ...
    @Test
    void sortByAge() {
        Faculty faculty1 = new Faculty("Griffindor", "yellow");
        Faculty faculty2 = new Faculty("Slitherin", "yellow");
        Faculty faculty3 = new Faculty("Puffenduy", "Green");
